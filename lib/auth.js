...
export const authOptions = {
    ...
    callbacks: {
        ...
        async session({ session, token }) {
            ...
            try {
                // 1. Try to find existing profile by spotify_id
                ...
                if (!profile) {
                    console.log("Auth: Profile not found, creating new one for spotifyId:", spotifyId);
                    ...
                    if (createError) {
                        ...
                        profile = newProfile;
                        console.log("Auth: New profile created with UUID:", profile.id);
                    }
                } else {
                    // 3. Optional: Update existing profile's name/avatar
